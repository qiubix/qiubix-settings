...
if [ "$color_prompt" = yes ]; then
    PS1="${NORMAL}[${BCYAN}\A${NORMAL}][${debian_chroot:+($debian_chroot)}${GREEN}\u@${BRED}\h${NORMAL}][${BBLUE}\w${NORMAL}]\$ "
else
...
#export CLASSPATH=".:/home/qiubix/Dropbox/Java":"/home/qiubix/Dropbox/TIJ4/"
#export CLASSPATH="/home/qiubix/Dropbox/TIJ4/"
#export CLASSPATH="."
...
#PS1="[${debian_chroot:+($debian_chroot)}${BGREEN}\u@${BRED}\h${NORMAL}][${BBLUE}\w${NORMAL}]\$ "
...
#clear
#echo -ne "${BGREEN}" "Hello, $USER. Today is, "; date
#echo -e "${WHITE}"; cal ; 
